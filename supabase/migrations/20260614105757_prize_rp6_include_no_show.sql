...
--
-- 背景:
--   Arena賞金はMaster地位・称号獲得に対するReward。
--   相手がno_showであってもwinnerがMasterを獲得した場合は賞金対象。
--   no_contestとcancelledのみ除外する。
--
-- 維持する条件:
...
BEGIN
  ...
  --     match_kind = 'master'
  --     winner_user_id IS NOT NULL
  --     end_reason NOT IN ('no_contest', 'cancelled')  ← no_show は対象に含める
