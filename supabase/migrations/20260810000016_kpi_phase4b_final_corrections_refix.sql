-- =============================================================================
-- 20260810000016_kpi_phase4b_final_corrections.sql
-- KPI Phase 4-B Final Corrections (Migration 14 → 16 (refix: task_id ambiguity, last_step_reached alias) (bugfix: last_step_reached, summary reapply))
--
-- 修正内容:
