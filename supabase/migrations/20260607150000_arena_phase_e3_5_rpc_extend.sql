-- =============================================================================
-- Official Arena Phase E-3.5 — get_arena_detail RPC 拡張
-- my_match に以下を追加:
--   official_match_id (= official_matches.id, arena_matches.official_match_id)
--   match_kind
--   master_subtype
--   arena_match_id
--   official_match_status
--   online_game_id (修正: am.online_game_id から直接取得)
--   opponent_user_id / opponent_display_name
--   既存キー (round / scheduled_start_at / arena_match_status / my_side 等) は維持
-- =============================================================================
-- 変更対象: get_arena_detail(p_arena_id uuid) のみ
-- get_arena_overview() は変更しない
