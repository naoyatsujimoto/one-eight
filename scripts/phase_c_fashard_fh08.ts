/**
 * phase_c_fashard_fh08.ts
 *
 * sim_batch_id=fahard_20260520_008 の sim_medium_pattern_stats への差分 upsert。
 * import_fashard_fh08.ts（Phase A）完了後に実行する。
 *
 * 設計:
...
async function main() {
  ...
  log('\n→ 次: phase_d_posonly_fashard_fh08.ts を実行して sim_position_only_stats を更新');
  log('=== Phase C 完了 ===');
}
