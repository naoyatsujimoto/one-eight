/**
 * import_sim_easy_s10.ts
 *
 * sim_easy_vs_easy_20260512.md (5,000局) を取り込む。
 * sim_batch_id: easy_20260512_010
 *
 * 実行方法:
 *   cd ~/Desktop/ONE_EIGHT/one-eight-web-mvp
 *   npx vite-node scripts/import_sim_easy_s10.ts
 *
 * フェーズ分割設計（タイムアウト耐性）:
...
const SIM_FILE_PATH = '/Users/nt/Desktop/Claude_Cowork/sim_easy/sim_easy_vs_easy_20260512.md';
const SIM_BATCH_ID = 'easy_20260512_010';
...
async function main() {
  console.log('=== import_sim_easy_s10.ts ===');
