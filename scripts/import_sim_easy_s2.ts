/**
 * import_sim_easy_s2.ts
 *
 * sim_easy_vs_easy_20260507.md をパースして sim_match_logs / sim_position_stats に取り込む。
 *
 * 実行方法:
 *   cd ~/Desktop/ONE_EIGHT/one-eight-web-mvp
 *   npx vite-node scripts/import_sim_easy_s2.ts
 *
 * 前提:
...
const SIM_FILE_PATH = '/Users/nt/Desktop/Claude_Cowork/sim_easy/sim_easy_vs_easy_20260508.md';
const SIM_BATCH_ID = 'easy_20260508_002';
...
async function main() {
  console.log('=== import_sim_easy_s2.ts ===');
