/**
 * phase_c_fvhard_007.ts
 *
 * sim_batch_id=fvhard_20260702_007 の sim_medium_pattern_stats への差分 upsert。
 * import_fvhard_007.ts（Phase A）完了後に実行する。
 */
