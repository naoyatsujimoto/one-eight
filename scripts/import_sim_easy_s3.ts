/**
 * import_sim_easy_s3.ts
 *
 * sim_easy_vs_easy_20260508b.md をパースして sim_match_logs / sim_position_stats に取り込む。
 *
 * 実行方法:
 *   cd ~/Desktop/ONE_EIGHT/one-eight-web-mvp
 *   npx vite-node scripts/import_sim_easy_s3.ts
 *
 * 前提:
...
const SIM_FILE_PATH = '/Users/nt/Desktop/Claude_Cowork/sim_easy/sim_easy_vs_easy_20260508b.md';
const SIM_BATCH_ID = 'easy_20260508_003';
const SIM_POLICY = 'easy_vs_easy';
const SIM_VERSION = '1.0.0';
const ENGINE_VERSION = '1.0.0';
const RULES_VERSION = '1.1.0';
const GENERATED_AT = '2026-05-08T00:00:00Z'; // s3
...
async function main() {
  console.log('=== import_sim_easy_s3.ts ===');
