...
const SIM_FILE_PATH = '/Users/nt/Desktop/Claude_Cowork/sim_easy/sim_easy_vs_easy_20260507.md';
const SIM_BATCH_ID = 'easy_20260507_001';
const SIM_POLICY = 'easy_vs_easy';
const SIM_VERSION = '1.0.0';
const ENGINE_VERSION = '1.0.0';
const RULES_VERSION = '1.1.0';
const GENERATED_AT = '2026-05-07T00:00:00Z';
...
async function main() {
  console.log('=== import_sim_easy_s1.ts ===');
