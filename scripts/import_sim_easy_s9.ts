/**
 * import_sim_easy_s9.ts
 *
 * sim_easy_vs_easy_20260511.md (5,000局) を取り込む。
 * sim_batch_id: easy_20260511_009
 *
 * 実行方法:
 *   cd ~/Desktop/ONE_EIGHT/one-eight-web-mvp
 *   npx vite-node scripts/import_sim_easy_s9.ts
 *
 * フェーズ分割設計（タイムアウト耐性）:
...
const SIM_FILE_PATH = '/Users/nt/Desktop/Claude_Cowork/sim_easy/sim_easy_vs_easy_20260511.md';
const SIM_BATCH_ID = 'easy_20260511_009';
const SIM_POLICY = 'easy_vs_easy';
const SIM_VERSION = '1.0.0';
const ENGINE_VERSION = '1.0.0';
const RULES_VERSION = '1.1.0';
const GENERATED_AT = '2026-05-11T00:00:00Z';
...
async function main() {
  console.log('=== import_sim_easy_s9.ts ===');
