/**
 * phase_c_fashard_fh01.ts
 *
 * sim_batch_id=fahard_20260515_001 の sim_medium_pattern_stats への差分 upsert。
 * import_fashard_fh01.ts（Phase A）完了後に実行する。
 *
 * 設計:
 *   - fahard_20260515_001 のみをスキャン（全量メモリ保持禁止）
...
async function main() {
  ...
  log('\n→ 次: phase_d_posonly_fashard_fh01.ts を実行して sim_position_only_stats を更新');
  log('=== Phase C 完了 ===');
}
