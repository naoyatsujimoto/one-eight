/**
 * phase_d_posonly_fashard_fh01.ts
 *
 * sim_batch_id=fahard_20260515_001 の sim_position_only_stats への差分 upsert。
 * phase_c_fashard_fh01.ts 完了後に実行する。
 *
 * 設計:
 *   - fahard_20260515_001 のみをスキャン
...
async function main() {
  log('=== phase_d_posonly_fashard_fh01.ts ===');
