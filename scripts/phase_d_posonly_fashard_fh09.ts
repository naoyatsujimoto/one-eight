/**
 * phase_d_posonly_fashard_fh09.ts
 *
 * sim_batch_id=fahard_20260520_009 の sim_position_only_stats への差分 upsert。
 * phase_c_fashard_fh09.ts 完了後に実行する。
 *
 * 設計:
...
async function main() {
  log('=== phase_d_posonly_fashard_fh09.ts ===');
