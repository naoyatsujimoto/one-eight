/**
 * phase_c_fvhard_006.ts
 *
 * sim_batch_id=fvhard_20260701_006 の sim_medium_pattern_stats への差分 upsert。
 * import_fvhard_006.ts（Phase A）完了後に実行する。
 */
