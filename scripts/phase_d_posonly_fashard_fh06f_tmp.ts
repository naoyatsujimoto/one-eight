/**
 * phase_d_posonly_fashard_fh06f.ts
 *
 * sim_batch_id=fahard_20260519_006 の sim_position_only_stats への差分 upsert。
 * phase_c_fashard_fh06f.ts 完了後に実行する。
 *
 * 設計:
 *   - fahard_20260519_006 のみをスキャン
 ...
 *   nohup node_modules/.bin/vite-node scripts/archive/phase_d_posonly_fashard_fh06f.ts > /tmp/fh06f_phase_d.log 2>&1 &
 *   tail -f /tmp/fh06f_phase_d.log
 */
...
async function main() {
  log('=== phase_d_posonly_fashard_fh06f.ts ===');
