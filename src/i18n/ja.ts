...
export const JA_TRANSLATIONS = {
    ...
    trainingT2Exp2: 'AssetとはGateに置く駒です。SlotとはAssetを置く場所です。Small、Middle、LargeのAssetは、それぞれ同じ大きさのSlotに置きます。',
    trainingT2Exp3: 'Assetの強さは大きさで比べます。',
    trainingT2Exp4: 'まずMassive Buildを行います。Massive Buildは、ひとつのGateのLarge SlotにLarge Assetを置くBuildです。',
    trainingT2Exp5: 'Gate 7に置かれた大きな駒がLarge Asset、その駒が入っている枠がLarge Slotです。Large Assetひとつは、同じGateのMiddle SlotとSmall Slotをすべて埋めるよりも強いBuildです。',
    trainingT2Exp6: '次はSelective Buildです。Selective Buildは、2つのGateのMiddle SlotにMiddle Assetをひとつずつ置くBuildです。',
    trainingT2Exp7: 'Gate 6とGate 8に置かれた駒がMiddle Asset、それぞれの駒が入っている枠がMiddle Slotです。同じGateでは、Middle AssetひとつはSmall Slotをすべて埋めるよりも強いBuildです。',
    trainingT2Exp8: '最後はQuad Buildです。Quad Buildは、選んだPositionにつながる4つのGateのSmall SlotにSmall Assetをひとつずつ置くBuildです。',
    trainingT2Exp9: 'Gate 1、2、7、12に置かれた小さな駒がSmall Asset、それぞれの駒が入っている枠がSmall Slotです。これで3種類のBuild upを確認しました。',
    ...
    statsVisibility: '戦績の公開設定',
    statsPublic: '公開',
    statsPrivate: '非公開',
    opponentStats: '相手の戦績',
    statsPrivateMsg: 'このプレイヤーの戦績は非公開です。',
    cpuProfiles: 'CPU 成績',
