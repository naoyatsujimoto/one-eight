...
export const T = {
  en: {
    ...
    authTagline: 'ONE EIGHT is a competitive board game, in the same category as Go, chess, and shogi.\nYou can log in to the game screen by email using the magic link below.\nYou can play the full game for free, and a monthly membership is also available.',
  ...
  ja: {
    ...
    authLogIn: 'ログイン',
    authLoggingIn: 'ログイン中…',
    authTagline: 'ONE EIGHT は競技性のあるボードゲームです（囲碁 / チェス / 将棋などと同カテゴリー）。\n下記マジックリンクよりメール経由でゲーム画面にログインすることができます。\n無料でゲームを完全にプレイすることができ、月額メンバーシップもあります。',
...
export type Translations = {
  ...
  arenaFinalizingResults: string;
  arenaFinalizingResultsHint: string;
  // E-6: Arena titles on Profile/UserPage
